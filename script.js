const products = {
  ...
  viriy: {
    title: "Вирій",
    category: "Домашній кальвадос · 43%",
    image: "assets/images/viriy.webp",
    story: "Кажуть, у часи, коли Перун гримів над горами, а Велес ходив поміж людей, у карпатських лісах ріс священний яблуневий сад. Хитрий Лис зібрав найкращі плоди, перегнав їхній сік у мідному кубі та запечатав напій у дубовій бочці. Домовики берегли її, доки час не надав напою сили й теплого бурштинового характеру. Той, хто куштує «Вирій», відчуває подих дороги до світла та силу духу, що допомагає йти власним шляхом.",
    mood: "Яблуко · дуб · мідний куб · слов’янська легенда",
    quote: "Дар землі, дерева і духу."
  },
  "pryvorotne-zillia": {
    title: "Приворотне Зілля",
    category: "Карпатський трав’яний біттер · 38%",
    image: "assets/images/pryvorotne-zillia.webp",
    story: "Одного осіннього вечора до корчми Хитрого Лиса прийшла дівчина й попросила зілля, здатне привернути серце коханого. Лис відповів: справжнє зілля не примушує кохати — воно лише дає сміливість відкрити власне серце. Він настояв карпатські трави, коріння, ялівець, прянощі й цитрусову цедру, доки напій не набув кольору гірського золота. Відтоді кажуть: він не закохує, а проганяє страх із серця.",
    mood: "Карпатські трави · ялівець · прянощі · золото",
    quote: "А далі кожен творить власну магію."
  }
};
